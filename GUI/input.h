...
#define INPUT_PLANET_N_LINES (3+2*INPUT_QUANTITY_N_LINES+INPUT_BODY_N_LINES)

#define INPUT_PLANET_SYS_MIN_N_LINES (INPUT_PLANET_N_LINES + 2/*Separator line + hButton_new_elem line*/)
...
#define input_obj_set_defctrls(obj,name,_line_start,n_tab) \
	...
	(obj).hButton_destroy = CreateWindow(WC_BUTTON,DESTROY_BUTTON_TEXT,WS_VISIBLE|WS_BORDER|WS_CHILD|BS_LEFT|BS_PUSHBUTTON,ntab_to_screen(n_tab),line_to_screen(_line_start+2),DESTROY_BUTTON_WIDTH,LINE_HEIGHT,__hMainWnd,NULL,__hIns,NULL); \
